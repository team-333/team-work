...
public class MainController {
	...
	public ModelAndView headersearch(HttpSession session,@RequestParam("searchtext") String searchtext) {
		ModelAndView mv = new ModelAndView("main");
		
		List<StudyVO> studylist =new ArrayList<StudyVO>();
		studylist =ss.searchText(searchtext);
		Collections.sort(studylist);
		for(StudyVO s : studylist) {
